...
module.exports = function pankycoin(host, port, peers, logLevel, name, feeAddress) {
    ...
    let httpServer = new HttpServer(name, node, blockchain, operator, miner, feeAddress);
